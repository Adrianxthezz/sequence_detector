...
initialize_floorplan -core_utilization 0.5 -core_shape R -orientation N  -core_side_ratio {1.0 1.0}  -core_offset {1} -flip_first_row true  -coincident_boundary true
...
#width:3pitch:15
create_pg_mesh_pattern pg_mesh1 -layers {{{horizontal_layer: met3 met5} {width: 1} {spacing: 1} {pitch: 15} {trim: true} }} -via_rule {} 
create_pg_mesh_pattern pg_mesh2 -layers {{{vertical_layer: met2 met4} {width: 1} {spacing: 1} {pitch: 15} {trim: true} }} -via_rule {}
