...
write_file -format verilog -hier -out outputs/mapped_fsm_sky130.v
write_file -format ddc -hier -out outputs/mapped_fsm_sky130.ddc
write_sdc ../constraints/mapped_fsm_sky130.sdc
# Exit
return
exit
